...
exports.runAgentWorkflow = runAgentWorkflow;
const preference_agent_1 = require("./preference-agent");
const venue_agent_1 = require("./venue-agent");
 ...
 */
async function runAgentWorkflow(gatheringId) {
    try {
        ...
        const preferenceAnalysis = await (0, preference_agent_1.analyzePreferences)(gathering.responses, gathering.timeOptions, // Cast JSON to array
        gathering.location);
